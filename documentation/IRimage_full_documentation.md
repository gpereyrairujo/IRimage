...
&nbsp; <img src="http://latex.codecogs.com/svg.latex?S=G\cdot&space;L&plus;O"> &nbsp; &nbsp; &nbsp; &nbsp; (Eq.1)
...
&nbsp; <img src="http://latex.codecogs.com/svg.latex?L_{\lambda}=\varepsilon&space;\cdot&space;\frac{2hc^{2}}{\lambda^{5}&space;}&space;\cdot&space;\frac{1}{e^{\frac{hc}{\lambda&space;kT}}-1}"> &nbsp; &nbsp; &nbsp; &nbsp; (Eq.2)
...
&nbsp; <img src="http://latex.codecogs.com/svg.latex?L_{\lambda}=\varepsilon&space;\cdot&space;\frac{1}{R\cdot&space;(e^{\frac{B}{T}}-1)}"> &nbsp; &nbsp; &nbsp; &nbsp; (Eq.3)
...
&nbsp; <img src="http://latex.codecogs.com/svg.latex?S=G\cdot&space;\varepsilon&space;\cdot&space;\frac{1}{R\cdot&space;(e^{\frac{B}{T}}-1)}&plus;O"> &nbsp; &nbsp; &nbsp; &nbsp; (Eq.4)
